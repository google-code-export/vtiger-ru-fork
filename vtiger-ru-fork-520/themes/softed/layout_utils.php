...
if ($other_text) {
	$the_form .= "<td width='20'><IMG height='1' src='themes/softed/images/blank.gif'></td>\n";
	$the_form .= "<td valign='bottom' class='formHeader' width='100%'>$other_text</td>\n";
}
else {
	$the_form .= "<td><IMG height='1' src='themes/softed/images/blank.gif'></td>\n";
}
...
$the_title .= "<td width='100%'><IMG height='1' src='themes/softed/images/blank.gif'></td>";
...
$the_title .= "</tr><tr><td colspan='4' width='100%' class='hline'><IMG width='100%' height='1' src='themes/softed/images/blank.gif'></td>";
