...
var alert_arr = {
      ...
      NO_PRODUCT_SELECTED:'Продукт не выбран. Выберите хотя бы один Продукт',
      ...
      SELECTED_MORE_THAN_ONCE:'Вы выбрали следующий продукт(ы) больше чем один раз.',
      YES:'да',
      NO:'нет',
      MAIL:'письмо',
...
// Added after 5.0.4 GA
	...
	PRO_MANDATORY: 'Выберите обязательное поле Название Продукта',
	...
	ALL_FILTER_CREATION_DENIED:'Невозможно создать Пользовательский Вид используя название "All", попробуйте использовать другое Название Вида',
	...
	IS_PARENT : 'Этот Продукт имеет Субпродукты, Вам не разрешено выбирать Родительский Продукт',
