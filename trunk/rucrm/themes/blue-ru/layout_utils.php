...
/*********************************************************************************
 * $Header$
 * Описание: Содержит различные вспомогательные функции используются для отображения
 * компонентов пользовательского интерфейса, такие как формы верхних и нижних колонтитулов.
 * Предназначен для изменение основновной темы.
 ********************************************************************************/
...
$the_header = <<<EOQ
       <table width="100%" cellpadding="0" cellspacing="0" border="0"><tbody><tr>
	   	<td width="4" height="20"><img src="themes/blue-ru/images/head_start.gif"></td>	
        <td class="leftFormHeader" vAlign="middle" align="left" noWrap height="20">$left_title</td>
		<td width="4" height="20"><img src="themes/blue-ru/images/head_end.gif"></td>	
		</tr></tbody></table>
...
if ($other_text) {
	$the_form .= "<td width='20'><IMG height='1' src='themes/blue-ru/images/blank.gif'></td>\n";
	$the_form .= "<td valign='bottom' class='formHeader' width='100%'>$other_text</td>\n";
}
else {
	$the_form .= "<td><IMG height='1' src='themes/blue-ru/images/blank.gif'></td>\n";
}
...
$the_title .= "<td width='100%'><IMG height='1' src='themes/blue-ru/images/blank.gif'></td>";

if ($show_help) {
//	$the_title .= "<td class='bodySmall' nowrap align='right'> <A href='phprint.php?jt=".session_id().$GLOBALS['request_string']."'><img align=absmiddle hspace=3 border=0 src='themes/blue-ru/images/print.gif'>".$app_strings['LNK_PRINT']."</A> &nbsp;</td>\n";
//	$the_title .= "<td class='bodySmall' nowrap align='right'> <A href='http://www.vtiger.com/products/crm/document.html' target='_blank'><img align=absmiddle hspace=3 border=0 src='themes/blue-ru/images/help_icon.gif'>".$app_strings['LNK_HELP']."</A></td>\n";
}
else {
...
$the_title .= "</tr><tr><td colspan='4' width='100%' class='hline'><IMG width='100%' height='1' src='themes/blue-ru/images/blank.gif'></td>";
