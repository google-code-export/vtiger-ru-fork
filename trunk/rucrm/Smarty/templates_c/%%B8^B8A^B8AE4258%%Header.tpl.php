<?php /* Smarty version 2.6.18, created on 2011-03-13 17:56:36
         compiled from Header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Header.tpl', 78, false),array('modifier', 'escape', 'Header.tpl', 86, false),array('modifier', 'getTranslatedString', 'Header.tpl', 112, false),array('modifier', 'vtlib_purify', 'Header.tpl', 388, false),array('function', 'math', 'Header.tpl', 637, false),)), $this); ?>
...
<tr>
<!-- LOGO -->
	 <td style="width:150px" class=small>&nbsp;<img border="0" title="vtiger CRM" <img src="<?php echo vtiger_imageurl('vtiger-crm.gif', $this->_tpl_vars['THEME']); ?>
" width=150px height=35px></td> 
...
"> 
		...
		<!-- Вход и Выход 
		<tr>
		 <td style="padding-left:5px;padding-right:5px" class=small nowrap><a href="index.php?module=Users&action=Logout"><?php echo $this->_tpl_vars['APP']['LBL_LOGOUT']; ?>
><img src="<?php echo vtiger_imageurl('exit.gif', $this->_tpl_vars['THEME']); ?>
"</a> (<?php echo $this->_tpl_vars['CURRENT_USER']; ?>
)</td>
		</tr> -->
		 <!--		 <td style="padding-left:10px;padding-right:10px" class=small nowrap><img src="<?php echo vtiger_imageurl('exit.gif', $this->_tpl_vars['THEME']); ?>
"> <a href="index.php?module=Users&action=Logout"><?php echo $this->_tpl_vars['APP']['LBL_LOGOUT']; ?>
</a> (<?php echo $this->_tpl_vars['CURRENT_USER']; ?>
)</td> -->
			 </tr>
	</td>
...
<div id="status" style="position:absolute;display:none;left:1450px;top:65px;height:27px;white-space:nowrap;"><img src="<?php echo vtiger_imageurl('status.gif', $this->_tpl_vars['THEME']); ?>
"></div>
<script>
function openwin()
{
