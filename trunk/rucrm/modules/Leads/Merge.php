...
/*else if($extension == "rtf" and $dolabels)
{
    $numlabels=8;
    ...
    $handle = fopen($wordtemplatedownloadpath.$filename,"wb");
    $new_filecontent = crmmergelabels($csvheader,$filecontent,$numlabels);
    fwrite($handle,$new_filecontent);
    fclose($handle);            
    echo "&nbsp;&nbsp;<font size=+1><b><a href=test/wordtemplatedownload/$filename>".$app_strings['DownloadMergeFile']."</a></b></font><br>";
}*/
...
<script>
//var filenameExtension = "<?php echo GetFileExtension($filename); ?>";
