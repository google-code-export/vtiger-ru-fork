...
function getContactforPDF($contact_id)
{
	...
	if($contact_id != '')
	{
			...
			if (trim($firstname)!=''){
				if (substr_count($salutation,"Prof. Dr."))
				 $contact_name = 'Prof. Dr. '.$firstname.' '.$lastname;
				elseif (substr_count($salutation,"Prof."))
				 $contact_name = 'Prof. '.$firstname.' '.$lastname;
				elseif (substr_count($salutation,"Dr."))
				...
				if (substr_count($salutation,'Prof. Dr.'))
				 $contact_name = $contact_salutation.'Prof. Dr. '.$lastname;
				elseif (substr_count($salutation,'Prof.'))
