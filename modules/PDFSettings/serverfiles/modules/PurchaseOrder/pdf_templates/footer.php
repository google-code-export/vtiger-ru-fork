...
if ($footerradio =='true') {
	...
	$this->Cell($this->GetStringWidth($org_name),$this->getFontSize(),$org_name,0,0,'L');
	$this->SetXY(PDF_MARGIN_LEFT , -PDF_MARGIN_FOOTER+12);
	$this->Cell($this->GetStringWidth($org_address),$this->getFontSize(),$org_address,0,0,'L');
	$this->SetXY(PDF_MARGIN_LEFT , -PDF_MARGIN_FOOTER+16);
	$this->Cell($this->GetStringWidth($org_code),$this->getFontSize(),$org_code." ".$org_city,0,0,'L');
	$this->SetXY(PDF_MARGIN_LEFT , -PDF_MARGIN_FOOTER+20);
	$this->Cell($this->GetStringWidth($org_country),$this->getFontSize(),$org_country,0,0,'L');
	//draw line
	...
	$this->Cell($this->GetStringWidth($bank_name),$this->getFontSize(),$bank_name,0,0,'L');
