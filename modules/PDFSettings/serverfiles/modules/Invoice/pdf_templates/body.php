...
if ($invoice_status=='Credit Invoice' and ($purpose!='printsn' and $purpose!='savesn')) $pdf->Cell($pdf->GetStringWidth($pdf_strings['CREDIT']),$pdf->getFontSize(), $pdf_strings['CREDIT'],0,1);
elseif ($purpose=='printsn' or $purpose=='savesn') $pdf->Cell($pdf->GetStringWidth($pdf_strings['SALESNOTE']),$pdf->getFontSize(), $pdf_strings['SALESNOTE'],0,1);
...
$description = str_replace('$contacts-salutation$',$contact_salutation,$description);
$description = str_replace('$contacts-firstname$',$contact_firstname,$description);
$description = str_replace('$contacts-lastname$',$contact_lastname,$description);
$description = str_replace('$users-firstname$',$owner_firstname,$description);
$description = str_replace('$users-lastname$',$owner_lastname,$description);
$description = str_replace('$users-title$',$owner_title,$description);
...
// special output for shipping note
if ($purpose=='printsn'){
$column_body_content['Position']['selected'] = 'checked="checked"';
$column_body_content['Description']['selected'] = 'checked="checked"';
$column_body_content['Qty']['selected'] = 'checked="checked"';
$column_body_content['OrderCode']['selected'] = '';
$column_body_content['Unit']['selected'] = '';
$column_body_content['UnitPrice']['selected'] = '';
$column_body_content['Discount']['selected'] = '';
$column_body_content['Tax']['selected'] = '';
$column_body_content['LineTotal']['selected'] = '';
}
...
$pdf->SetFont( $default_font, "", $font_size_body);
$conditions = str_replace('$contacts-salutation$',$contact_salutation,$conditions);
$conditions = str_replace('$contacts-firstname$',$contact_firstname,$conditions);
$conditions = str_replace('$contacts-lastname$',$contact_lastname,$conditions);
$conditions = str_replace('$users-firstname$',$owner_firstname,$conditions);
$conditions = str_replace('$users-lastname$',$owner_lastname,$conditions);
$conditions = str_replace('$users-title$',$owner_title,$conditions);
