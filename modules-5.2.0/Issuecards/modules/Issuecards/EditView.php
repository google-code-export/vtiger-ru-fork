...
if (isset ($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') {
	...
	$Issuecards_associated_prod = getIssuecardsAssociatedProducts($focus);
	$focus->id = "";
	$focus->mode = '';
}
...
if ($focus->mode == 'edit') {
	...
	$associated_prod = getIssuecardsAssociatedProducts($focus);
	$smarty->assign("ASSOCIATEDPRODUCTS", $associated_prod);
	$smarty->assign("MODE", $focus->mode);
}
elseif (isset ($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') {
	$associated_prod = $Issuecards_associated_prod;
	$smarty->assign("AVAILABLE_PRODUCTS", 'true');
	$smarty->assign("MODE", $focus->mode);
}
...
//in create new Issuecards, get all available product taxes and shipping & Handling taxes
...
if ($focus->mode == 'edit' || $_REQUEST['isDuplicate'] == 'true') {
	$inventory_cur_info = getIssuecardsInventoryCurrencyInfo('Issuecards', $focus->id);
